...
SECRET_KEY = '+1$-oy2132zhy*o@dg%b&odw1y$n7%((+ah!*$_vq2&0qc@0sh'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1','yogicrm.herokuapp.com']
...
heroku config:set DISABLE_COLLECTSTATIC=1 --app yogicrm
'''